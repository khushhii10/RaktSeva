...
out.print("</style>");
  out.print("</head>");
            ...
            String s11="select * from dschedule";
            ...
            ResultSet rs=st.executeQuery(s11);
             ...
             out.print("<th>"); out.print("Gender"); out.print("</th>");
            ...
            out.print("<td>"); out.print("<button value='Edit' style='font-size:'30px'>");out.print("</button>");out.print("<button value='Delete' style='font-size:'30px'>");out.print("</button>");out.print("</td>");
            out.print("</tr>");
            }
            out.print("</table>");
            out.print("</center>");
